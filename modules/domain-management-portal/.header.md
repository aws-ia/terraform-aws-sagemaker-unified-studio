# SageMaker Unified Studio Administration Project Module

This module creates the singleton **Administration project** for an Amazon SageMaker Unified Studio domain. The Administration project is a special project type (`project_category = "ADMIN"`) that serves as the provisioner for bring-your-own-role projects when the new domain management portal experience is enabled.
