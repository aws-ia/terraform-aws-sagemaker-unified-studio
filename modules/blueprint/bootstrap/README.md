...
| <a name="input_configure_lake_formation"></a> [configure\_lake\_formation](#input\_configure\_lake\_formation) | Whether to configure Lake Formation data lake settings with admin permissions for SageMaker roles | `bool` | `true` | no |
...
| <a name="output_lake_formation_configured"></a> [lake\_formation\_configured](#output\_lake\_formation\_configured) | Whether Lake Formation data lake settings have been configured |
