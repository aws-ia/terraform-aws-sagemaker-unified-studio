...
This example replicates the [AWS Console quick-setup experience](https://docs.aws.amazon.com/sagemaker-unified-studio/latest/userguide/quick-setup.html) for Amazon SageMaker Unified Studio as closely as possible using Terraform resources.
